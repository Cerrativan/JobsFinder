...
import com.example.jobsfinder.ui.home.HomeFragmentDirections
import com.example.jobsfinder.ui.search.SearchFragmentDirections
import com.example.jobsfinder.utilities.AdWithOwner

class HomeAdapter(private var list: ArrayList<AdWithOwner>): RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            it.findNavController().navigate(
                HomeFragmentDirections.actionNavigationHomeToSearchDialogFragment4(list[position].title, list[position].city,
